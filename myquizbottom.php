...
if($que<$qnum)
{
        ...
        $result2 = $con->query($sql2);
	     ...
	     while($row2 = $result2->fetch_assoc()) {
			...
			$msg="resulthead.php?qid=".$qid."&qid2=".$qid22."&que=".$que."&eid=".$eid."&sid=".$sid."&eid2=".$eid2;
	        header('Location:'.$msg);
...
}else
{
        ...
        $result3 = $con->query($sql3);
	     ...
	     while($row3 = $result3->fetch_assoc()) {
	      ...
	      <?php  if($myvar!=null)
	      {   $pic="Questions\\".$myvar;?> 
	           <img src="<?php echo "$pic";?>" alt="No Image" width=200 height="150"><br>
	        <?php } ?>
	...
	?>
	<a href="<?php echo "$url";?>" target="_parent"><input type=button value="Exit"></a>
	<?php }
